...
public class Amfibi extends Animal {
     ...
     * @param fecundacio
     */
    public Amfibi (int codi_animal, String medi, String dieta, boolean sexe, float codi_veterinari, float codi_cuidador, boolean veri, boolean larva, boolean fecundacio){
        this.veri = veri;
        this.larva = larva;
    ...
    */
    ...
    public String toString() {
        return "Amfibi amb codi = " + codi_animal + ", medi = " + medi + ", dieta = " + dieta + ", sexe = " + sexe + ", veterinari = " + codi_veterinari + ", cuidador = " + codi_cuidador + ", veri = " + veri + ", larva = " + larva + ", fecundacio = " + fecundacio + "";
    }
