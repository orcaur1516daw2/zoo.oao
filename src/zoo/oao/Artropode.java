...
public class Artropode extends Animal {
     ...
     */
    public Artropode(int codi_animal, String medi, String dieta, boolean sexe, float codi_veterinari, float codi_cuidador, boolean venenos, boolean antenes, int numero_potes_art) {
    ...
    */
    ...
    public String toString() {
        return "Artropode amb codi = " + codi_animal + ", medi = " + medi + ", dieta = " + dieta + ", sexe = " + sexe + ", codi_veterinari = " + codi_veterinari + ", codi_cuidador = " + codi_cuidador + ", venenos = " + venenos + ", antenes = " + antenes + ", numero_potes_art = " + numero_potes_art + "";
    }
