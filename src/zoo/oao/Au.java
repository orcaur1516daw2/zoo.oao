...
public class Au extends Animal {
    ...
    * 
     ...
     * @param volador
    */
    public Au (int codi_animal, String medi, String dieta, boolean sexe, float codi_veterinari, float codi_cuidador, boolean volador){
    ...
    */
    ...
    public String toString() {
        return "Au amb codi = " + codi_animal + ", medi = " + medi + ", dieta = " + dieta + ", sexe = " + sexe + ", codi_veterinari = " + codi_veterinari + ", codi_cuidador = " + codi_cuidador + ", volador = " + volador + "";
    }
}  
