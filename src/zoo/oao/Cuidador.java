 ...
 * @param horari
 */
public Cuidador (int codi_personal, double sou, String DNI, double nss, String horari) {
 ...
 */
    ...
    public String toString() {
        return  "Cuidador amb codi = " + codi_personal + ", sou = " + sou + ", DNI = " + DNI + ", nss = " + nss + ", horari = " + horari + "";
    }
