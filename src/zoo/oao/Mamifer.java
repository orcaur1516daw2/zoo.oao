...
public class Mamifer extends Animal {
    ...
    */
    ...
    public Mamifer (int codi_animal, String medi, String dieta, boolean sexe, float codi_veterinari, float codi_cuidador, boolean placentari){
    ...
    */
    ...
    public String toString() {
        return "Mamifer amb codi = " + codi_animal + ", medi = " + medi + ", dieta = " + dieta + ", sexe = " + sexe + ", codi_veterinari = " + codi_veterinari + ", codi_cuidador = " + codi_cuidador + ", placentari = " + placentari + "";
    }
