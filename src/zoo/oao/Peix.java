...
public class Peix extends Animal {
     ...
     * @param aigua
     */ 
    public Peix (int codi_animal, String medi, String dieta, boolean sexe, float codi_veterinari, float codi_cuidador, boolean esquelet, String aigua){
    ...
    */
    ...
    public String toString() {
        return "Peix amb codi = " + codi_animal + ", medi = " + medi + ", dieta = " + dieta + ", sexe = " + sexe + ", codi_veterinari = " + codi_veterinari + ", codi_cuidador = " + codi_cuidador + ", esquelet = " + esquelet + ", aigua = " + aigua + "";
    }
