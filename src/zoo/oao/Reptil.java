...
public class Reptil extends Animal {
    ...
    * Per insertar el tipus de reproducció on: ovípars = 1 ovovivípars = 0
     ...
     * @param potes
    */
    public Reptil (int codi_animal, String medi, String dieta, boolean sexe, float codi_veterinari, float codi_cuidador, boolean tipus_reproduccio, boolean potes){
    ...
    */
    ...
    public String toString() {
        return "Reptil amb codi = " + codi_animal + ", medi = " + medi + ", dieta = " + dieta + ", sexe = " + sexe + ", codi_veterinari = " + codi_veterinari + ", codi_cuidador = " + codi_cuidador + ", tipus_reproduccio = " + tipus_reproduccio + ", potes = " + potes + "";
    }
